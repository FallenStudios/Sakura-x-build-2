...
module.exports.run = (client, message, args) => {
  ...
  osutils.cpuUsage(function(v) {
    ...
    .setColor(0x7289DA)
    .setThumbnail(`https://cdn.discordapp.com/avatars/${client.id}/2189c071f81b58045729a60ecb81ad00.png?size=2048`)
    .setURL(`https://cdn.discordapp.com/avatars/${client.id}/2189c071f81b58045729a60ecb81ad00.png?size=2048`)
    .setTimestamp()
    ...
    .addField("Developer", `xFallen54x#2399`, true)
    .setFooter(`© Sakura X Bot by xFallen54x#2399`);
        message.channel.send({embed});
  })
}

module.exports.name = "Botstats"
module.exports.aliases = ["botinfo"]
module.exports.usage = `botstats`
module.exports.description = "Shows the stats of the bot"